...
import com.example.auctionsystem.fragment.LoginFragment;
import com.example.auctionsystem.fragment.SignupFragment;
...
public class MainActivity extends OrmActivity implements LoginFragment.LoginCallbacks, SignupFragment.SignupCallbacks{
    ...
    protected void onStop() {
        super.onStop();
        if (splashTask != null && !splashTask.isCanceled()) {
