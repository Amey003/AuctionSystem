...
import com.example.auctionsystem.model.ItemPhoto;
import com.example.auctionsystem.model.User;
import com.example.auctionsystem.util.Constants;
import com.example.auctionsystem.util.Utils;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    public List<User> getUsersByUsername(String username) throws SQLException, java.sql.SQLException {
    ...
    public User loginUser(String username, String password) throws SQLException, java.sql.SQLException {
        QueryBuilder<User, Long> queryBuilder = getUserRuntimeDao().queryBuilder();
    ...
    public List<AuctionItem> getOpenAuctions(User user) throws SQLException, java.sql.SQLException {
    ...
    public List<AuctionItem> getMyAuctions(User user) throws SQLException, java.sql.SQLException {
        QueryBuilder<AuctionItem, Long> queryBuilder = getItemRuntimeDao().queryBuilder();
        queryBuilder.where().eq("owner_id", user);
        return getItemRuntimeDao().query(queryBuilder.prepare());
    }

    public Bid getHighestBid(long auctionId) throws SQLException, java.sql.SQLException {
    ...
    public Bid getUserBid(long itemId, long userId) throws SQLException, java.sql.SQLException {
        QueryBuilder<Bid, Long> queryBuilder = getBidRuntimeDao().queryBuilder();
    ...
    public List<AuctionItem> getAuctionsWon(User user) throws SQLException, java.sql.SQLException {
    ...
    public List<Bid> getAuctionBids(long auctionId) throws SQLException, java.sql.SQLException {
        QueryBuilder<Bid, Long> queryBuilder = getBidRuntimeDao().queryBuilder();
        queryBuilder.where().eq("item_id", auctionId);
        return getBidRuntimeDao().query(queryBuilder.prepare());
    }

    public List<User> getSystemUser() throws SQLException, java.sql.SQLException {
        QueryBuilder<User, Long> queryBuilder = getUserRuntimeDao().queryBuilder();
